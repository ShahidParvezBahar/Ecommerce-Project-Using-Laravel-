...
function add_to_cart(id, size_str_id, color_str_id)
{
  ...
  {
    jQuery('#add_to_cart_msg').html('<div class="alert alert-info fade in alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>Please Select Size</div>');
  }

  else if(color_id=='' && color_id!='no')
  {
    jQuery('#add_to_cart_msg').html('<div class="alert alert-info fade in alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close" title="close">×</a>Please Select Color</div>');
  }
