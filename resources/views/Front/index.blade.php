...
@section('page_title','Home Products')
@section('container')
          ...
          <ul class="seq-canvas">
            ...
            <li>
              ...
              <div class="seq-title">                       
                ...
                <a data-seq href="{{$list->btn_link}}" class="aa-shop-now-btn aa-secondary-btn" target="_blank">{{$list->btn_txt}}</a>
              </div>
              @endif
            </li>
            @endforeach
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade {{$cat_class}}" id="cat{{$list->id}}">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="{{url('product/'.$productArr->slug)}}"><img src="{{asset('storage/media/'.$productArr->image)}}" alt="{{$productArr->image}}"></a>
