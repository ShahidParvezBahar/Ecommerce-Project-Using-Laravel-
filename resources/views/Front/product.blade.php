            ...
            <div class="aa-product-related-item">
              ...
              <ul class="aa-product-catg aa-related-item-slider">
                ...
                @if(isset($related_product[0]))
                  @foreach($related_product as $productAttr)
                <li>
                  <figure>
                    <a class="aa-product-img" href="{{url('product/'.$productAttr->slug)}}"><img src="{{asset('storage/media/'.$productAttr->image)}}" alt="$productAttr->image" width="100%"></a>

                    <a class="aa-add-card-btn"href="{{url('product/'.$productAttr->slug)}}"><span class="fa fa-shopping-cart"></span>Add To Cart</a>
                     <figcaption>
                      <h4 class="aa-product-title"><a href="{{url('product/'.$productAttr->slug)}}">{{$productAttr->name}}</a></h4>
                      <span class="aa-product-price">Tk. {{$related_product_attr[$productAttr->id][0]->price}}</span><span class="aa-product-price"><del>Tk. {{$related_product_attr[$productAttr->id][0]->mrp}}</del></span>
                    </figcaption>
                  </figure>                     
